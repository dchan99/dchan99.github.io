...
function draw() {
  ...
  if (!gameStart) {
    ...
    text("Press W or UP or Z to move spaceship forward", width/2, 100)
    text("Press S or DOWN or X to stop spaceship", width/2, 150)
    text("Press SPACE to fire your SINGLE bullet", width/2, 200)
